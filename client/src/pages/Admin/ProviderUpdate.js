...
const ProviderUpdate = () => {
    ...
    const getCategory = async () => {
        try {
          const { data } = await axios.get(`/api/v1/provider/single-provider/${params.id}`);
          console.log(data)
    ...
    const handleCreate = async (e) => {
      ...
      try {
        ...
        const { data } = await axios.put(`/api/v1/provider/update-provider/${params.id}` , productData);
    ...
    return (
      <Layout title={"Actualizar Proveedor"}>
        <div className="">
          <div className="row">
            ...
            <div className="col-md-9">
              <h1 className="mt-4">Actualizar Proveedor</h1>
              <form onSubmit={handleCreate}>
                <div className="row pt-3 pb-3 mb-3" style={{ backgroundColor: "#eee", borderRadius: "12px" }}>
                  ...
                  <div className="text-center">
                    <img
                      src={`/api/v1/provider/provider-photo/${params.id}`}
                      alt="product_photo"
                      height={"200px"}
                      className="img img-responsive"
                    />
